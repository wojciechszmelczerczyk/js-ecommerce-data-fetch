...
Furthest distance between users calculated by geolocation points.
...
```json
{
  "distanceBetween": 15012.083838780349,
  "firstUser": { "firstname": "kate", "lastname": "hale" },
  "secondUser": { "firstname": "jimmie", "lastname": "klein" }
}
```
...
This section presents source code of furthest distance between users function implementation.
